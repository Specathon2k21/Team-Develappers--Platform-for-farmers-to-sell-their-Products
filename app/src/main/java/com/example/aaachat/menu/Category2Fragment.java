...
import com.example.aaachat.adapter.CallListAdapter;
import com.example.aaachat.model.CallList;
...
public class Category2Fragment extends Fragment {
    ...
    public static Category2Fragment newInstance(String param1, String param2) {
